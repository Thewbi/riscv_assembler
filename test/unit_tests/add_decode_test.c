...
void add_decode_valid_input_test(void **state) {
...
void add_decode_2_valid_input_test(void **state) {

    // Arrange

    // https://www.eg.bucknell.edu/~csci206/riscv-converter/index.html
    // add    t0, t0, t0  == 0x00A28333 = 0000000 00101 00101 000 00101 0110011
    uint32_t data = 0x005282B3;
    asm_line_t asm_line;
    ...
    assert_int_equal(R_T0, asm_line.reg_rs1);
    assert_int_equal(R_T0, asm_line.reg_rs2);
