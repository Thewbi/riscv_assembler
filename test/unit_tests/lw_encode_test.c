 ...
 * lw x15, -20(x8)
 */
void lw_encode_valid_input_test(void **state)
{
    // Arrange
    ...
    uint32_t result = encode_lw(&parser_asm_line);

    // Assert

    //assert_int_equal(0x01442783, result);
    assert_int_equal(0xfec42783, result);
}
